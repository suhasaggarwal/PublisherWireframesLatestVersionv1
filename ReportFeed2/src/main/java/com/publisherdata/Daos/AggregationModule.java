  ...
  */
  ...
  public List<PublisherReport> getQueryFieldChannelFilter(String queryfield,String startdate, String enddate, String channel_name, Map<String,String>filter, String filtermetric)
		    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
		  {
	        ...
	        query = "Select SUM(engagementTime1),"+queryfield+" from enhanceduserdatabeta1 where "+queryfilterbuilder+" and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'"+" GROUP BY "+queryfield;
...
public List<PublisherReport> getQueryFieldChannelGroupByLive(String queryfield,String startdate, String enddate, String channel_name, List<String> groupby, String filter)
  ...
  public List<PublisherReport> getQueryFieldChannelArticle(String queryfield,String startdate, String enddate, String channel_name,String articlename, String filter)
		    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
		  {
	  String query= "";
      ...
      query = "Select "+queryfield+",cookie_id FROM enhanceduserdatabeta1 where refcurrentoriginal like '%"+articlename+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "' GROUP by "+ queryfield+",cookie_id";  
		    ...
		    if (queryfield.equals("clickedArticles")) {
		   		...
		   		pubreport=module.getChannelArticleReferredPostsListInternal(startdate, enddate, channel_name, articlename, filter);
		        return pubreport;  
		      }
  ...
  public List<PublisherReport> getQueryFieldChannelArticleFilter(String queryfield,String startdate, String enddate, String channel_name,String articlename, Map<String,String>filter, String filterMetric)
		    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
		  {
	        ...
	        if(filterMetric != null && !filterMetric.isEmpty() && filterMetric.equals("engagementTime"))
		     query = "Select SUM(engagementTime1),"+queryfield+" from enhanceduserdatabeta1 where "+queryfilterbuilder+" and refcurrentoriginal like '%"+articlename+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield;
		  ...
		  */
		  ...
		  public List<PublisherReport> getQueryFieldChannelSectionFilter(String queryfield,String startdate, String enddate, String channel_name, String sectionname, Map<String,String>filter, String filtermetric)
				    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
				  {
			        ...
			        if(filtermetric != null && !filtermetric.isEmpty() && filtermetric.equals("engagementTime") )
			        query = "Select SUM(engagementTime1),"+queryfield+" from enhanceduserdatabeta1 where "+queryfilterbuilder+" and refcurrentoriginal like '%"+sectionname+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY "+queryfield;
      ...
      for (Map.Entry<String, String> entry : filter.entrySet())
      {
          ...
          j++;
		    ...
		    */
		    ...
		    String query10 = "Select SUM(engagementTime1) from enhanceduserdatabeta1 where "+queryfilterbuilder+"and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'";
  ...
  public List<PublisherReport> countBrandNameChannelArticle(String startdate, String enddate, String channel_name, String articlename)
		...
		//		 List<String> lines00 = csvResult00.getLines();
		  ...
		  public List<PublisherReport> getChannelArticleReferredPostsListInternal(String startdate, String enddate, String channel_name, String articlename, String filter)
				    throws SQLFeatureNotSupportedException, SqlParseException, CsvExtractorException, Exception
				  {
				    String query1 = "Select count(*),clickurloriginal from enhanceduserdatabeta1 where refcurrentoriginal like '%"+articlename+"%' and channel_name = '" + channel_name + "' and date between " + "'" + startdate + "'" + " and " + "'" + enddate + "'" + " GROUP BY clickurloriginal";
